...
The current `0.1.0-alpha.4` release is a functional developer preview. It provides a complete local migration workflow plus foundational Git and package restoration features. Alpha releases are intended for controlled testing and should not be used as the only backup of important data.
